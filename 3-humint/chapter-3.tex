...
The practice of spying is a little more complicated. It's clearly wrong, in the sense that treason and espionage are punished harshly under essentially every legal code. In many countries it is an unforgivable sin, where even falling under suspicion can lead to imprisonment, torture, and death. While the latter two punishments are sometimes criticized on human-rights grounds, no one disputes the right of a nation to punish those who work against them in service of a foreign power. Legally, as you will see in a moment, spies are function as enemy combatants who are afforded none of the customary protections typically given to soldiers. The nation that sends a spy into a foreign country explicitly asks them to commit crimes on their behalf, and the spy risks paying the full price, all by themselves, if they are caught committing them.

You probably already feel like you know why countries don't punish each other more harshly for espionage, even though every member of the international community outlaws it in their own backyard. That is because, generally speaking, civil society conditions us to think of intelligence operations as one of those things that every country \emph{just does}. Since that is not likely to change, the best we can do is hope that our government is using the appropriate discretion in choosing to undertake these missions that we know nothing about, and expect that they are defending against those same attempts by others. That nations will use their intelligence agencies to collect the state secrets of others is, in its barest form, a relatively noncontroversial premise. After all, why else would intelligence agencies exist?
...
% Valentino: This is REALLY good stuff here, but I think it belongs in your intro theory section. I'd love to see you (1) explore this more theoretically, and (2) see if there is any evidence of this as the real reason for the lax norms.
...
% Valentino: In the same introduction you would want to spell this out in more detail, considering the security dilemma and some of the game theoretical implications (this is like a prisoner's dilemma - I'd prefer to be the only one who can spy, but I can't prevent you from spying).
...
% Valentino: Again, this is a key point but it doesn't belong here. You should talk about this in the theory section, In the case section you should be providing evidence that this dynamic is what caused the norms to take shape as they did.
